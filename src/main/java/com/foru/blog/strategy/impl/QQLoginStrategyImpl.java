...
import com.foru.blog.config.properties.QQConfigProperties;
import com.foru.blog.dto.qq.QQTokenDTO;
import com.foru.blog.dto.qq.QQUserInfoDTO;
...
import static com.foru.blog.enums.StatusCodeEnum.QQ_LOGIN_ERROR;
...
public class QQLoginStrategyImpl extends AbstractSocialLoginStrategyImpl {
    ...
    public SocialUserInfoDTO getSocialUserInfo(SocialTokenDTO socialTokenDTO) {
        ...
        return SocialUserInfoDTO.builder()
                ...
                .avatar(replaceHttp(qqUserInfoDTO.getFigureurl_qq_1()))
                .thirdId(socialTokenDTO.getOpenId())
                .build();
    }
