...
import com.foru.blog.dao.ArticleDao;
import com.foru.blog.dao.TalkDao;
import com.foru.blog.dao.UserInfoDao;
import com.foru.blog.dto.blog.*;
import com.foru.blog.vo.*;
import com.foru.blog.entity.Comment;
import com.foru.blog.dao.CommentDao;
import com.foru.blog.service.BlogInfoService;
import com.foru.blog.service.CommentService;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.foru.blog.service.RedisService;
import com.foru.blog.util.HTMLUtils;
...
import static com.foru.blog.enums.CommentTypeEnum.*;
...
public class CommentServiceImpl extends ServiceImpl<CommentDao, Comment> implements CommentService {
    ...
    public void saveComment(CommentVO commentVO) {
        ...
        Comment comment = Comment.builder()
                ...
                .commentContent(HTMLUtils.filter(commentVO.getCommentContent()))
    ...
    public void notice(Comment comment) {
        ...
        if (StringUtils.isNotBlank(email)) {
            ...
            rocketMQTemplate.convertAndSend(MQPrefixConst.EMAIL_TOPIC,emailDTO);
        }
    }
